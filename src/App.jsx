...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0e27] via-[#1a1f3a] to-[#000000]">
      <Header />
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="lg:sticky lg:top-24 space-y-6">
              ...
              {error && (
                <div className="p-5 bg-red-900/30 backdrop-blur-sm text-red-200 rounded-2xl border border-red-500/30 flex items-center gap-3 shadow-lg animate-in fade-in slide-in-from-top-2">
            ...
            {isProcessing && (
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 shadow-xl p-12 text-center">
                <div className="relative inline-block mb-6">
                  ...
                  <div className="relative w-16 h-16 border-4 border-white/20 border-t-purple-400 rounded-full animate-spin"></div>
                </div>
                <p className="text-white font-bold text-lg">Analyzing your content...</p>
